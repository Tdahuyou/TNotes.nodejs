...
- [1. 📒 概述](#1--概述)
- [2. 📒 `os` 模块常用 API](#2--os-模块常用-api)
  - [2.1. 操作系统信息](#21-操作系统信息)
  - [2.2. CPU 信息](#22-cpu-信息)
  - [2.3. 内存信息](#23-内存信息)
  - [2.4. 网络接口信息](#24-网络接口信息)
  - [2.5. 其他信息](#25-其他信息)
- [3. 💻 demos.1 - 获取操作系统平台和类型](#3--demos1---获取操作系统平台和类型)
- [4. 💻 demos.2 - 获取 CPU 和内存信息](#4--demos2---获取-cpu-和内存信息)
- [5. 💻 demos.3 - 获取网络接口信息](#5--demos3---获取网络接口信息)
- [6. 💻 demos.4 - 获取主机名及运行时间](#6--demos4---获取主机名及运行时间)
